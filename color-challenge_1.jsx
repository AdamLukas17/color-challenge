    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      <Card>
        ...
        <div style={{ fontSize: "14px", color: theme.textSecondary, marginBottom: "20px", lineHeight: 1.5 }}>
          Take {MAX_PHOTOS} photos that contain {todayColor.name} anywhere in the frame. We match by color family, so different shades and lighting conditions all count!
        </div>
